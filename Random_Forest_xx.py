...
required_packages = ['pandas', 'openpyxl', 'numpy', 'matplotlib', 'sklearn']
...
performance_results.to_excel("RandomForest_Performans_Sonuclari_Optimized.xlsx", index=False)
print("Performans sonuçları 'RandomForest_Performans_Sonuclari_Optimized.xlsx' dosyasına kaydedildi.")
...
plt.legend()
plt.title("Random Forest Gerçek Değerler ve Tahminler")
plt.show()
...
plt.title("Random Forest Gerçek ve Tahmin Karşılaştırması")
plt.show()
